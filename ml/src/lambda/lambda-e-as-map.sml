...
structure Env = UnbalancedFiniteMap(DupInts)

datatype value = Null
               | IntVal of int
               | Closure of int * lexp * value Env.Map
               | AppVal of lexp * lexp
...
fun eval_rel (Var k) env = Env.lookup (k, env)
...
fun buildEnv l =
    let
        fun aux _ [] = Env.empty
          | aux index (h :: t) = Env.bind (index, h, (aux (index + 1) t))
    in
        aux 0 l
    end
...
val identity_of_99 = eval_rel (APP (ABS 1 (Var 1)) (Var 0)) (buildEnv [IntVal 99])
...
val first_of_88_99 = eval_rel (APP2 FIRST (Var 0) (Var 1)) (buildEnv [IntVal 88, IntVal 99])
val second_of_88_99 = eval_rel (APP2 SECOND (Var 0) (Var 1)) (buildEnv [IntVal 88, IntVal 99])

val eval_TRUE = eval TRUE
val identity_of_TRUE = eval (APP (ABS 1 (Var 1)) TRUE)
val first_of = eval (ABS2 0 1 (Var 0))
val FIRST_of_TRUE_FALSE_rel = eval_rel (APP2 FIRST (Var 0) (Var 1)) (buildEnv [Closure (0, TRUE, Env.empty), Closure(0, TRUE, Env.empty)])
...
val CBV_COND_TRUE_88_99 = eval_rel (APP3 COND TRUE (Var 0) (Var 1)) (buildEnv [IntVal 88, IntVal 99])
val CBV_COND_FALSE_88_99 = eval_rel (APP3 COND FALSE (Var 0) (Var 1)) (buildEnv [IntVal 88, IntVal 99])
...
val IS_EMPTY_CONS_TRUE_NIL = eval (APP ISEMPTY (APP2 CONS TRUE NIL))




val list_0_1_2_3 = APP2 CONS (Var 0) (APP2 CONS (Var 1) (APP2 CONS (Var 2) (APP2 CONS (Var 3) NIL)))
val num_env = (buildEnv [IntVal 66, IntVal 77, IntVal 88, IntVal 99])
...
val PAIR_88_99 = eval_rel (APP2 PAIR (Var 0) (Var 1)) (buildEnv [IntVal 88, IntVal 99])
val SECOND_OF_PAIR_88_99 = eval_rel (APP SECOND_OF_PAIR (APP2 PAIR (Var 0) (Var 1))) (buildEnv [IntVal 88, IntVal 99])
